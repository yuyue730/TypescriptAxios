...
describe('helpers:headers', () => {
  ...
  describe('processHeaders', () => {
    ...
    test('should set content-type if Content-Type not set and data plain object', () => {
      const headers: any = {}
    ...
    test('should not set content-type if data not plain object', () => {
      const headers: any = {}
    ...
    test('should do nothing if data null or undefined', () => {
  ...
  describe('flattenHeaders', () => {
    test('should flatten headers include method and common', () => {
      const headers: any = {
    ...
    test('should flatten the headers without common', () => {
      const headers = {
        Accept: 'application/json',
        get: {
          'X-GET-HEADER': 'getHeaderValue'
    ...
    test('should do nothing if headers null or undefined', () => {
