...
function registerWithCredentialsRouter() {
  router.get('/withCredentials/get', function(req, res) {
...
function registerWithUploadRouter() {
  router.post('/upload_download/upload', function(req, res) {
    console.log(req.body, req.files)
    res.end('Upload/Download success!')
  })
}

function registerAuthorizationRouter() {
  router.post('/authorization/post', function(req, res) {
